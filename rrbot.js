...
} = require('./componentDialogs/makeReservationDialog');
const {
    CancelReservationDialog
} = require('./componentDialogs/cancelReservationDialog');
...
class RRBOT extends ActivityHandler {
    ...
    async dispatchToIntentAsync(context, intent, entities) {
        ...
        if (previousIntent.intentName && conversationData.endDialog === false) {
            ...
            previousIntent.intentName && conversationData.endDialog === true
        ) {
        ...
        case 'Make_Reservation':
            ...
            if (conversationData.endDialog) {
                await this.previousIntent.set(context, { intent: null });
        ...
        default:
            console.log('Did not match Make Reservation or cancel reservation case. Sent to QnAMaker.ai');
            break;
        }
    }
}
